...
class Scenario(object):
    ...
    def scenario12(self):
        ...
        incoming_car_spawn_point = carla.Transform()
        incoming_car_spawn_point.location.x = -1.5
        incoming_car_spawn_point.location.y = 150
        incoming_car_spawn_point.location.z = 0.01
        incoming_car_spawn_point.rotation.yaw = 90
        incoming_car_bp = random.choice(self.world.get_blueprint_library().filter("vehicle.audi.tt"))
        incoming_car_bp.set_attribute('role_name', Config.Carla.INCOMING_VEHICLE_ROLENAME)
        car = [incoming_car_bp, incoming_car_spawn_point]
        ...
        parked_car_bp = random.choice(self.world.get_blueprint_library().filter("vehicle.audi.tt"))
        parked_car_bp.set_attribute('role_name', Config.Carla.PARKED_VEHICLE_ROLENAME)
        parked_car = [parked_car_bp, parked_car_spawn_point]
    ...
    def scenario11(self):
        ...
        incoming_car_spawn_point = carla.Transform()
        incoming_car_spawn_point.location.x = -2
        incoming_car_spawn_point.location.y = 60
        incoming_car_spawn_point.location.z = 0.01
        incoming_car_spawn_point.rotation.yaw = 270

        # randomize vehicle type
        vehicles = ["vehicle.audi.a2", "vehicle.audi.tt", "vehicle.chevrolet.impala", "vehicle.audi.etron"]
        vehicle_type = random.choice(vehicles)
        incoming_car_bp = random.choice(self.world.get_blueprint_library().filter(vehicle_type))
        color = random.choice(incoming_car_bp.get_attribute('color').recommended_values)
        incoming_car_bp.set_attribute('color', color)
        incoming_car_bp.set_attribute('role_name', Config.Carla.PARKED_VEHICLE_ROLENAME)
        ...
        vehicles = ["vehicle.audi.a2", "vehicle.audi.tt", "vehicle.chevrolet.impala", "vehicle.audi.etron"]
        vehicle_type = random.choice(vehicles)
        parked_car_bp = random.choice(self.world.get_blueprint_library().filter(vehicle_type))
        color = random.choice(parked_car_bp.get_attribute('color').recommended_values)
        parked_car_bp.set_attribute('color', color)
        parked_car_bp.set_attribute('role_name', Config.Carla.PARKED_VEHICLE_ROLENAME)
    ...
    def scenario10(self):
        ...
        walker_bp = self.world.get_blueprint_library().filter("walker.pedestrian.0001")
        walker_spawn_point = carla.Transform()
        walker_spawn_point.location.x = 5.5  # 2 For testing purposes
        ...
        incoming_car_spawn_point = carla.Transform()
        incoming_car_spawn_point.location.x = -1.5
        incoming_car_spawn_point.location.y = 130
        incoming_car_spawn_point.location.z = 0.01
        incoming_car_spawn_point.rotation.yaw = 90
    ...
    def scenario08(self):
        ...
        parked_car_spawn_point = carla.Transform()
        parked_car_spawn_point.location.x = 4.8
        parked_car_spawn_point.location.y = 206
        parked_car_spawn_point.location.z = 0.5
        parked_car_spawn_point.rotation.yaw = 90
        ...
        car = [parked_car_bp, parked_car_spawn_point]
        obstacles.append(car)
