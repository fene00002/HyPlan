...
public:
	BlindPolicy(const DSPOMDP* model, ACT_TYPE action, ParticleLowerBound* particle_lower_bound);
...
public:
	...
	RandomPolicy(const DSPOMDP* model, const std::vector<double>& action_probs, ParticleLowerBound* ParticleLowerBound);
